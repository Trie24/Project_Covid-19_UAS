...
import com.tripurwanto.covid19app.adapter.ProvAdapter;
import com.tripurwanto.covid19app.api.provData.ProvData;
import com.tripurwanto.covid19app.util.LoadLocale;
import com.tripurwanto.covid19app.vm.ProvDataViewModel;
...
public class MapsFragment extends Fragment implements
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        ShimmerFrameLayout mProvCardShimmer = this.requireView().findViewById(R.id.prov_shimmer);

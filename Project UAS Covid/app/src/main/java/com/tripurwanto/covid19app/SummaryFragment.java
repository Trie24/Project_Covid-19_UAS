...
import com.tripurwanto.covid19app.R;
import com.tripurwanto.covid19app.WorldHistory;
import com.tripurwanto.covid19app.WorldSummaryModel;
import com.tripurwanto.covid19app.WorldSummaryViewModel;
...
public class SummaryFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    private void loadWorldData() {
        ...
        refreshData(true);
        viewModel.getSummaryWorldData().observe(getViewLifecycleOwner(), new Observer<WorldSummaryModel>() {
            @Override

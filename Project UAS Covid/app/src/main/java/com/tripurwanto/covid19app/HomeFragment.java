...
import com.tripurwanto.covid19app.adapter.NewsAdapter;
import com.tripurwanto.covid19app.api.newsData.NewsData;
import com.tripurwanto.covid19app.ui.BottomSheetPreventionDialog;
import com.tripurwanto.covid19app.ui.BottomSheetPrixaDialog;
import com.tripurwanto.covid19app.util.LoadLocale;
import com.tripurwanto.covid19app.util.SpacesItemDecoration;
import com.tripurwanto.covid19app.vm.NewsDataViewModel;
...
import static com.tripurwanto.covid19app.R.drawable;
import static com.tripurwanto.covid19app.R.id;
import static com.tripurwanto.covid19app.R.string;
import static com.tripurwanto.covid19app.R.layout;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        newsDataViewModel.getLoading().observe(getViewLifecycleOwner(), new Observer<Boolean>() {
            @Override
        ...
        newsDataLiveData.observe(getViewLifecycleOwner(), new Observer<NewsData>() {
            @Override
